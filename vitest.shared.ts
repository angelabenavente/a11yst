...
export const sharedVitestConfig = defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@a11yst/source-mapping-html": resolve(
        __dirname,
        "packages/source-mapping-html/src/index.ts",
      ),
      "@a11yst/source-mapping-react": resolve(
        __dirname,
        "packages/source-mapping-react/src/index.ts",
      ),
      "@a11yst/source-mapping-next": resolve(
        __dirname,
        "packages/source-mapping-next/src/index.ts",
      ),
      "@a11yst/source-mapping-vue": resolve(
        __dirname,
        "packages/source-mapping-vue/src/index.ts",
      ),
      "@a11yst/source-mapping-nuxt": resolve(
        __dirname,
        "packages/source-mapping-nuxt/src/index.ts",
      ),
      "@a11yst/source-mapping-angular": resolve(
        __dirname,
        "packages/source-mapping-angular/src/index.ts",
      ),
